...
use crate::events::buy_token_event::BuyTokenEvent;
...
impl<'a, 'b, 'c, 'info> From<&mut BuyToken<'info>>
    for CpiContext<'a, 'b, 'c, 'info, SwapBaseIn<'info>>
{
    fn from(
        accounts: &mut BuyToken<'info>,
...
pub fn buy_token(
    ...
    msg!(
        "BuyTokenEvent emitted: owner={}, src_mint={}, dst_mint={}, amount={}, timestamp={}",
